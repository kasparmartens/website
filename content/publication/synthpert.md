...
abstract_short = "To enhance LLM biological reasoning about cell perturbation outcomes, we fine-tune models on synthetic reasoning traces from frontier LLMs, achieving substantial performance gains on PerturbQA."
